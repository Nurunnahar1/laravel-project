                            ...
                            <div class="row">
                                <div class="col-lg-8 col-md-7 col-sm-12 left">
                                    ...
                                    <div class="room-detail-carousel owl-carousel">
                                        <div class="item"
                                            style="background-image:url({{ asset('uploads/room/' . $single_room_data->featured_photo) }});">
                                            <div class="bg"></div>
                                        </div>

                                        @foreach ($single_room_data->roomPhotos as $item)
                                            <div class="item"
                                                style="background-image:url({{ asset('uploads/roomPhoto/' . $item->photo) }});">
                                                <div class="bg"></div>
                                            </div>
                                        @endforeach
                                    ...
                                    <div class="description">
                                        <p>{{ $single_room_data->description }}</p>
                                    </div>
                                    ...
                                    <div class="amenity">
                                        ...
                                        <div class="row">
                                            @php
                                                $array = explode(',', $single_room_data->amenities);
                                    ...
                                    <div class="feature">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                <tr>
                                                    <th>Room Size</th>
                                                    <td>{{ $single_room_data->room_size }}</td>
                                                </tr>
                                                <tr>
                                ...
                                <div class="col-lg-4 col-md-5 col-sm-12 right">
                                    ...
                                    <div class="sidebar-container" id="sticky_sidebar">
                                        ...
                                        <div class="widget">
                                            ...
                                            <form action="{{ route('cartMethod') }}" method="post">
                                                @csrf
                                                <input type="hidden" name="room_id"
                                                    value="{{ $single_room_data->id }}">
                                                <div class="form-group mb_20">
                                                    <label for="">Check in & Check out</label>
                                                    <input type="text" name="checkin_checkout"
                                                        class="form-control daterange1" placeholder="Checkin & Checkout">
                                                </div>
                                                <div class="form-group mb_20">
                                                    <label for="">Adult</label>
                                                    <input type="number" name="adult" class="form-control" min="1"
                                                        max="30" placeholder="Adults">
                                                </div>
                                                <div class="form-group mb_20">
                                                    <label for="">Children</label>
                                                    <input type="number" name="children" class="form-control"
                                                        min="0" max="30" placeholder="Children">
                                                </div>
