...
@section('body')
                                ...
                                <div class="swiper-slide ">
                                    <div class="hero__slider--items">
                                        <div class="hero__slider--thumbnail">
                                            <img class="hero__slider--thumbnail__img display-block" src="{{asset($item->image ?? "no-image.jpg")}}" alt="slider img">
                                        </div>
                                        <div class="slider__content text-center">
                                            <h2 class="slider__content--maintitle h1">{{$item->title}}</h2>
                                            <p class="slider__content--desc d-sm-2-none">{{$item->content}}</p>
                                            <div class="slider__content--footer d-flex align-items-center justify-content-center">
                                                ...
                                                <div class="bideo__play slider__play--bideo">
                                                    <a class="bideo__play--icon glightbox" href="{{$item->v_url}}" data-gallery="video">
    ...
    <section class="image__with--text__section section--padding">
            ...
            <div class="row row-cols-md-2 row-cols-1  align-items-center">
                <div class="col">
                    <div class="image__with--text__thumbnail">
                        <img class="display-block" src="{{asset('frontend/assets/img/other/drone-image.webp')}}" alt="drone-image">
                    </div>
                </div>
                <div class="col">
                    <div class="image__with--text__content">
                        ...
                        <div class="image__with--text__content--footer d-flex">
                            <img class="display-block" src="{{asset('frontend/assets/img/other/text-shape.webp')}}" alt="text-shape">
        ...
        <img class="image__with--text__position--shape display-block" src="{{asset('frontend/assets/img/other/image-with-text-section-shape.webp')}}" alt="shape img">
    </section>
            ...
            <div class="row row-cols-lg-2 row-cols-md-2 row-cols-1 align-items-center">
                    ...
                    <div class="about__content">
                        ...
                        <div class="about__content--author d-flex align-items-center mb-50">
                            <div class="about__content--author__thumb">
                                <img class="display-block" src="{{asset('frontend/assets/img/other/about-author.webp')}}" alt="about author thumb">
                            </div>
                            <div class="about__content--author__text d-flex align-items-center">
                                ...
                                <img class="about__author--signature display-block" src="{{asset('frontend/assets/img/icon/signature.webp')}}" alt="signature">
                            </div>
                        </div>
                ...
                <div class="col">
                    <div class="about__thumbnail">
                        <img class="display-block" src="{{asset('frontend/assets/img/other/about-thumb.webp')}}" alt="about-thumb">
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="{{asset('frontend/assets/img/product/small-product1.webp')}}" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="{{asset('frontend/assets/img/product/small-product2.webp')}}" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="{{asset('frontend/assets/img/product/small-product3.webp')}}" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="{{asset('frontend/assets/img/product/small-product4.webp')}}" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="product__media--preview__items">
                                                <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{asset('frontend/assets/img/product/big-product1.webp')}}"><img class="product__media--preview__items--img" src="{{asset('frontend/assets/img/product/big-product1.webp')}}" alt="product-media-img"></a>
                                                <div class="product__badge">
                                                    <span class="product__badge--items sale">New</span>
                                                </div>
                                                <div class="product__media--view__icon">
                                                    <a class="product__media--view__icon--link glightbox" href="{{asset('frontend/assets/img/product/big-product1.webp')}}" data-gallery="product-media-preview">
                        ...
                        <div class="product__details--info">
                            <form action="#">
                                        ...
                                        <fieldset class="variant__input--fieldset">
                                            ...
                                            <div class="variant__color d-flex">
                                                <div class="variant__color--list">
                                                    ...
                                                    <label class="variant__color--value red" for="color-red1" title="Red"><img class="variant__color--value__img" src="{{asset('frontend/assets/img/product/small-product1.webp')}}" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red2" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red2" title="Black"><img class="variant__color--value__img" src="{{asset('frontend/assets/img/product/small-product2.webp')}}" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red3" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red3" title="Pink"><img class="variant__color--value__img" src="{{asset('frontend/assets/img/product/small-product3.webp')}}" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red4" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red4" title="Orange"><img class="variant__color--value__img" src="{{asset('frontend/assets/img/product/small-product4.webp')}}" alt="variant-color-img"></label>
                                                </div>
                                            </div>
                                        </fieldset>
                                    </div>
                                ...
                                <div class="guarantee__safe--checkout">
                                    ...
                                    <img class="guarantee__safe--checkout__img display-block" src="{{asset('frontend/assets/img/other/safe-checkout.webp')}}" alt="Payment Image">
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <div class="banner__video--section banner__section--bg position__relative section--padding">
        <img class="drone__position--img display-block" src="{{asset('frontend/assets/img/other/drone-position-img.webp')}}" alt="drone-position-img">
        <div class="container">
            ...
            <div class="team__container">
                <div class="row row-cols-md-3 row-cols-sm-2 row-cols-2 mb--n30">
                    <div class="col custom-col mb-30">
                        <article class="team__card">
                            <div class="team__card--thumbnail">
                                <img class="team__card--thumbnail__img display-block" src="{{asset('frontend/assets/img/other/team1.webp')}}" alt="team-thumb">
                            </div>
                    ...
                    <div class="col custom-col mb-30">
                        <article class="team__card">
                            <div class="team__card--thumbnail">
                                <img class="team__card--thumbnail__img display-block" src="{{asset('frontend/assets/img/other/team2.webp')}}" alt="team-thumb">
                            </div>
                            <div class="team__card--content ">
                    ...
                    <div class="col custom-col mb-30">
                        <article class="team__card">
                            <div class="team__card--thumbnail">
                                <img class="team__card--thumbnail__img display-block" src="{{asset('frontend/assets/img/other/team3.webp')}}" alt="team-thumb">
                            </div>
                            <div class="team__card--content ">
                        ...
                        <div class="row row-cols-md-3 row-cols-2 mb--n30">
                                ...
                                <article class="project__card ">
                                    <a class="project__card--link" href="shop.html">
                                        <div class="project__card--thumbnail">
                                            <img class="project__card--thumbnail__img display-block" src="{{asset('frontend/assets/img/product/product1.webp')}}" alt="product-img">
                                        </div>
                            ...
                            <div class="col custom-col-2 mb-30">
                                <article class="project__card ">
                                    <a class="project__card--link" href="shop.html">
                                        <div class="project__card--thumbnail">
                                            <img class="project__card--thumbnail__img display-block" src="{{asset('frontend/assets/img/product/product2.webp')}}" alt="product-img">
                                        </div>
                                        <div class="project__card--content d-flex justify-content-between align-items-center">
                                            <div class="project__card--content__left">
                            ...
                            <div class="col custom-col-2 mb-30">
                                <article class="project__card ">
                                    <a class="project__card--link" href="shop.html">
                                        <div class="project__card--thumbnail">
                                            <img class="project__card--thumbnail__img display-block" src="{{asset('frontend/assets/img/product/product3.webp')}}" alt="product-img">
                                        </div>
                                        <div class="project__card--content d-flex justify-content-between align-items-center">
                                            <div class="project__card--content__left">
                            ...
                            <div class="col custom-col-2 mb-30">
                                <article class="project__card ">
                                    <a class="project__card--link" href="shop.html">
                                        <div class="project__card--thumbnail">
                                            <img class="project__card--thumbnail__img display-block" src="{{asset('frontend/assets/img/product/product4.webp')}}" alt="product-img">
                                        </div>
                                        <div class="project__card--content d-flex justify-content-between align-items-center">
                                            <div class="project__card--content__left">
                            ...
                            <div class="col custom-col-2 mb-30">
                                <article class="project__card ">
                                    <a class="project__card--link" href="shop.html">
                                        <div class="project__card--thumbnail">
                                            <img class="project__card--thumbnail__img display-block" src="{{asset('frontend/assets/img/product/product5.webp')}}" alt="product-img">
                                        </div>
                                        <div class="project__card--content d-flex justify-content-between align-items-center">
                                            <div class="project__card--content__left">
                            ...
                            <div class="col custom-col-2 mb-30">
                                <article class="project__card ">
                                    <a class="project__card--link" href="shop.html">
                                        <div class="project__card--thumbnail">
                                            <img class="project__card--thumbnail__img display-block" src="{{asset('frontend/assets/img/product/product6.webp')}}" alt="product-img">
                                        </div>
                                        <div class="project__card--content d-flex justify-content-between align-items-center">
                                            <div class="project__card--content__left">
                                                <h3 class="project__card--content__title">Advanced Analytic</h3>
            ...
            <div class="blog__section--inner blog__swiper--activation swiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <article class="blog__card">
                            <div class="blog__card--thumbnail">
                                <a class="blog__card--thumbnail__link display-block" href="blog-details.html"><img class="blog__card--thumbnail__img display-block" src="{{asset('frontend/assets/img/blog/blog1.webp')}}" alt="blog-img"></a>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <article class="blog__card">
                            <div class="blog__card--thumbnail">
                                <a class="blog__card--thumbnail__link display-block" href="blog-details.html"><img class="blog__card--thumbnail__img display-block" src="{{asset('frontend/assets/img/blog/blog2.webp')}}" alt="blog-img"></a>
                            </div>
                            <div class="blog__card--content">
                                <ul class="blog__card--meta d-flex justify-content-center">
                                    <li class="blog__card--meta__text text__secondary">
                    ...
                    <div class="swiper-slide">
                        <article class="blog__card">
                            <div class="blog__card--thumbnail">
                                <a class="blog__card--thumbnail__link display-block" href="blog-details.html"><img class="blog__card--thumbnail__img display-block" src="{{asset('frontend/assets/img/blog/blog3.webp')}}" alt="blog-img"></a>
                            </div>
                            <div class="blog__card--content">
                                <ul class="blog__card--meta d-flex justify-content-center">
                                    <li class="blog__card--meta__text text__secondary">
